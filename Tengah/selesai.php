...
<body>
    ...
    <div class="container">
        <main>
            ...
            <p>Jika sudah mengisi form pengambilan akan muncul seperti ini dan pendaftaran anda sudah berhasil dan akan segera kami proses, dan kami akan segera menghubungi anda melalui email.</p>
            <img src="selesai.png" alt="Selesai 1" height="150">
        </main>
    </div>
